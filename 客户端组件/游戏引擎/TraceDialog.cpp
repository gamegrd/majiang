...
bool CTraceRichEdit::TraceString( LPCTSTR pszString, enGameTraceLevel TraceLevel )
{
...
bool CTraceRichEdit::TraceString(enGameTraceLevel TraceLevel, LPCTSTR pszString, ... )
{
...
COLORREF CTraceRichEdit::GetTraceColor( enGameTraceLevel TraceLevel )
{
	switch (TraceLevel)
	{
	case TraceLevel_Game_Info:
		return RGB(133, 124, 129);
		break;
	case TraceLevel_Game_Normal:
		return RGB(205, 215, 225);
		break;
	case TraceLevel_Game_Warning:
		return RGB(255, 0, 0);
		break;
	case TraceLevel_Game_Exception:
		return RGB(255, 0, 0);
		break;
	case TraceLevel_Game_Debug:

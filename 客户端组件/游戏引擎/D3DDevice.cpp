...
bool CD3DDevice::ResetD3DDevice()
{
	...
	if( FAILED( hResult ) ) 
	{
		TraceService->TraceString(TraceLevel_Game_Warning,TEXT("Reset D3D failed"));
		return false;
	}
	...
	TraceService->TraceString(TraceLevel_Game_Normal,TEXT("Reset D3D success"));
...
bool CD3DDevice::CreateD3DDevice( HWND hWndDevice, ID3DDeviceSink * pID3DDeviceSink )
{
	...
	TraceService->TraceString(TraceLevel_Game_Normal,TEXT("Current mode:%d*%d"),DisplayMode.Width,DisplayMode.Height);
	TraceService->TraceString(TraceLevel_Game_Normal,TEXT("Refresh Rate:%d"),DisplayMode.RefreshRate);
	TraceService->TraceString(TraceLevel_Game_Normal,TEXT("Format:%d\n"),DisplayMode.Format);
	...
	{
		TraceService->TraceString(TraceLevel_Game_Warning,TEXT("CreateDevice 【D3DDEVTYPE_HAL】 failed"));
		...
		{
			TraceService->TraceString(TraceLevel_Game_Warning,TEXT("CreateDevice 【D3DDEVTYPE_REF】 failed"));

			return false;
		}
	}

	TraceService->TraceString(TraceLevel_Game_Normal,TEXT("Device successfully created"));

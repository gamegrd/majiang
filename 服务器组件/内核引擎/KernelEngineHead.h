...
#define MAX_ASYNCHRONISM_DATA		20480								//异步数据
...
public:
	...
	//设置参数
	virtual bool  SetServiceParameter(WORD wServicePort, WORD wMaxConnect,const TCHAR*)=NULL;
...
public:
	...
	//批量发送
	virtual bool  SendDataBatch(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize,LONG)=NULL;
...
public:
	...
	//允许群发
	virtual bool  AllowBatchSend(DWORD dwSocketID, bool bAllowBatch,LONG)=NULL;
